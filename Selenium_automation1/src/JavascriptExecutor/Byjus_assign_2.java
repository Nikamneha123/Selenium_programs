...
public void Setup() {
	...
	public void Byjus2() throws InterruptedException {
		...
		driver.findElement(By.id("name-input")).sendKeys("neha");
		driver.findElement(By.xpath("//div[@class='col-sm-10 col-xs-9 phone-no-col']//input[@id='name-input']")).sendKeys("9921786358");
